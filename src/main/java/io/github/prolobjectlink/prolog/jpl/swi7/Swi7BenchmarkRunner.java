 ...
 * #L%
 */
package io.github.prolobjectlink.prolog.jpl.swi7;
...
public class Swi7BenchmarkRunner extends AbstractBenchmarkRunner implements BenchmarkRunner {
...
//                  D is ( P * 100 ) / A.
	...
	public static void main(String[] args) throws RunnerException {
		...
		builder.include(Swi7BenchmarkRunner.class.getSimpleName());
		Options opt = builder.build();
		Collection<RunResult> run = new Runner(opt).run();
		new Swi7BenchmarkRunner().output(run);
